...
public class RentalPart {
	...
	@Inject
	public RentalPart(Composite parent, RentalAgency rentalAgency) {
	...
	@Inject @Optional public void
	selectCustomers(@Named(IServiceConstants.ACTIVE_SELECTION) Object[] objects) {
		/*Arrays.stream(objects).filter(Customer.class::isInstance)
	 .map(this::setC);*/
	}
